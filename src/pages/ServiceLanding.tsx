...
Object.assign(serviceConfigs, {
  'conserto-geladeira-ribeirao-das-neves': {
    slug: 'conserto-geladeira-ribeirao-das-neves',
    title: 'Conserto de Geladeira em Ribeirão das Neves',
    subtitle: 'Técnico especializado na sua casa hoje',
    heroDescription: 'Geladeira não gela, faz barulho ou vazou água em Ribeirão das Neves? A SERVIBEL é especialista em conserto de geladeiras em Ribeirão das Neves com atendimento no mesmo dia. 35 anos de experiência cuidando do seu refrigerador.',
    ctaLabel: '🔧 Conserto de Geladeira Hoje',
    whatsappMessage: 'Olá SERVIBEL! Preciso de conserto/reparo na minha geladeira em Ribeirão das Neves. Vi pelo site.',
    location: 'Ribeirão das Neves',
    keywords: ['conserto geladeira Ribeirão das Neves', 'reparo geladeira Ribeirão das Neves', 'arrumar geladeira Ribeirão das Neves', 'técnico geladeira Ribeirão das Neves', 'refrigerador Ribeirão das Neves', 'geladeira não gela Ribeirão das Neves'],
    metaTitle: 'Conserto de Geladeira em Ribeirão das Neves | Técnico Hoje | SERVIBEL',
    metaDescription: 'Conserto de geladeira em Ribeirão das Neves com atendimento no mesmo dia. Reparo de compressor, gás e placa em Ribeirão das Neves. 35 anos. Garantia.',
    seoContent: 'Procurando conserto de geladeira em Ribeirão das Neves? A SERVIBEL é a assistência técnica de referência em Ribeirão das Neves há 35 anos. Resolvemos todos os problemas da sua geladeira em Ribeirão das Neves: não gela, não congela, barulho no compressor, vazamento de água, porta não fecha, gás vazando, termostato com defeito e placa eletrônica queimada. Atendemos todas as marcas de geladeira em Ribeirão das Neves: Brastemp, Electrolux, Consul, LG, Samsung, Panasonic e todas as outras. Nossos técnicos chegam até você em qualquer bairro de Ribeirão das Neves — Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Granjas Primavera, Vila Real e demais regiões. Conserto de geladeira em Ribeirão das Neves com peças originais e garantia escrita.',
    faqs: [
      { question: 'Vocês consertam geladeira em Ribeirão das Neves hoje?', answer: 'Sim! Atendimento no mesmo dia em Ribeirão das Neves para conserto de geladeira. Chame agora pelo WhatsApp.' },
      { question: 'Minha geladeira parou de gelar em Ribeirão das Neves, o que pode ser?', answer: 'Pode ser compressor, falta de gás, termostato ou placa. Nossos técnicos em Ribeirão das Neves fazem o diagnóstico completo na sua casa.' },
      { question: 'Consertam geladeira de todas as marcas em Ribeirão das Neves?', answer: 'Sim! Brastemp, Electrolux, Consul, LG, Samsung, Panasonic e todas as marcas em Ribeirão das Neves.' },
      { question: 'Quanto custa arrumar uma geladeira em Ribeirão das Neves?', answer: 'O orçamento é gratuito em Ribeirão das Neves. O reparo custa muito menos que uma geladeira nova.' },
      { question: 'Tem garantia o conserto de geladeira em Ribeirão das Neves?', answer: 'Sim! 90 dias de garantia escrita para todo conserto de geladeira em Ribeirão das Neves.' },
    ],
  },
  'conserto-freezer-ribeirao-das-neves': {
    slug: 'conserto-freezer-ribeirao-das-neves',
    title: 'Conserto de Freezer em Ribeirão das Neves',
    subtitle: 'Reparo especializado no mesmo dia',
    heroDescription: 'Freezer parou de gelar, acumula gelo demais ou faz barulho em Ribeirão das Neves? A SERVIBEL é especialista em conserto de freezers em Ribeirão das Neves há 35 anos. Atendimento rápido na sua casa.',
    ctaLabel: '❄️ Freezer Funcionando Hoje',
    whatsappMessage: 'Olá SERVIBEL! Preciso de conserto no meu freezer em Ribeirão das Neves. Vi pelo site.',
    location: 'Ribeirão das Neves',
    keywords: ['conserto freezer Ribeirão das Neves', 'reparo freezer Ribeirão das Neves', 'arrumar freezer Ribeirão das Neves', 'técnico freezer Ribeirão das Neves', 'freezer vertical Ribeirão das Neves', 'freezer horizontal Ribeirão das Neves'],
    metaTitle: 'Conserto de Freezer em Ribeirão das Neves | Reparo Hoje | SERVIBEL',
    metaDescription: 'Conserto de freezer em Ribeirão das Neves com atendimento no mesmo dia. Reparo de compressor, gás e termostato em Ribeirão das Neves. 35 anos. Garantia.',
    seoContent: 'Freezer com defeito em Ribeirão das Neves é prejuízo na certa: alimentos estragam e o comércio para. A SERVIBEL é a assistência técnica especializada em freezers em Ribeirão das Neves, com mais de 35 anos de experiência. Resolvemos em Ribeirão das Neves: freezer não gela, gelo excessivo, compressor com defeito, vazamento de gás, porta não veda, barulho anormal e termostato queimado. Atendemos freezers residenciais e comerciais em Ribeirão das Neves de todas as marcas: Brastemp, Electrolux, Consul, LG, Samsung, Continental e outras. Nossos técnicos vão até você em qualquer bairro de Ribeirão das Neves: Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Granjas Primavera e demais regiões. Conserto de freezer em Ribeirão das Neves com peças originais, orçamento gratuito e garantia escrita.',
    faqs: [
      { question: 'Meu freezer parou de gelar em Ribeirão das Neves, o que pode ser?', answer: 'Geralmente é compressor, falta de gás ou termostato. Nossos técnicos em Ribeirão das Neves fazem o diagnóstico na sua casa.' },
      { question: 'Vocês consertam freezer em Ribeirão das Neves no mesmo dia?', answer: 'Sim! Atendimento em até 24h em Ribeirão das Neves para conserto de freezer.' },
      { question: 'Consertam freezer comercial em Ribeirão das Neves?', answer: 'Sim! Atendemos freezers residenciais e comerciais de todas as marcas em Ribeirão das Neves.' },
      { question: 'Quanto custa o reparo de freezer em Ribeirão das Neves?', answer: 'Orçamento gratuito em Ribeirão das Neves. O reparo custa muito menos que comprar um freezer novo.' },
      { question: 'Tem garantia o conserto de freezer em Ribeirão das Neves?', answer: 'Sim! 90 dias de garantia escrita para todo conserto de freezer em Ribeirão das Neves.' },
    ],
  },
  'conserto-maquina-lavar-ribeirao-das-neves': {
    slug: 'conserto-maquina-lavar-ribeirao-das-neves',
    title: 'Conserto de Máquina de Lavar em Ribeirão das Neves',
    subtitle: 'Reparo especializado no mesmo dia',
    heroDescription: 'Máquina de lavar não centrifuga, vaza água ou não liga em Ribeirão das Neves? A SERVIBEL é especialista em conserto de máquinas de lavar em Ribeirão das Neves há 35 anos. Atendimento rápido na sua casa.',
    ctaLabel: '🌀 Máquina Funcionando Hoje',
    whatsappMessage: 'Olá SERVIBEL! Preciso de conserto na minha máquina de lavar em Ribeirão das Neves. Vi pelo site.',
    location: 'Ribeirão das Neves',
    keywords: ['conserto máquina de lavar Ribeirão das Neves', 'reparo máquina de lavar Ribeirão das Neves', 'arrumar máquina de lavar Ribeirão das Neves', 'técnico máquina de lavar Ribeirão das Neves', 'lavadora de roupas Ribeirão das Neves', 'máquina de lavar não centrifuga Ribeirão das Neves'],
    metaTitle: 'Conserto de Máquina de Lavar em Ribeirão das Neves | Reparo Hoje | SERVIBEL',
    metaDescription: 'Conserto de máquina de lavar em Ribeirão das Neves com atendimento no mesmo dia. Reparo de motor, bomba e placa em Ribeirão das Neves. 35 anos. Garantia.',
    seoContent: 'Máquina de lavar com defeito em Ribeirão das Neves? A SERVIBEL é a assistência técnica especializada em máquinas de lavar em Ribeirão das Neves há 35 anos. Resolvemos todos os problemas: máquina não liga, não enche, não esvazia, não centrifuga, vaza água, barulho excessivo, placa eletrônica com erro e correia rompida. Atendemos máquinas de lavar em Ribeirão das Neves de todas as marcas: Brastemp, Electrolux, Consul, LG, Samsung, Panasonic e outras. Nossos técnicos chegam até você em qualquer bairro de Ribeirão das Neves: Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Granjas Primavera, Vila Real e demais regiões. Conserto de máquina de lavar em Ribeirão das Neves com peças originais e garantia escrita.',
    faqs: [
      { question: 'Minha máquina de lavar não centrifuga em Ribeirão das Neves, o que pode ser?', answer: 'Pode ser correia rompida, motor, placa ou embreagem. Nossos técnicos em Ribeirão das Neves fazem o diagnóstico na sua casa.' },
      { question: 'Vocês consertam máquina de lavar em Ribeirão das Neves no mesmo dia?', answer: 'Sim! Atendimento em até 24h em Ribeirão das Neves para conserto de máquina de lavar.' },
      { question: 'Consertam máquina de lavar de todas as marcas em Ribeirão das Neves?', answer: 'Sim! Brastemp, Electrolux, Consul, LG, Samsung, Panasonic e todas as marcas em Ribeirão das Neves.' },
      { question: 'Quanto custa o reparo de máquina de lavar em Ribeirão das Neves?', answer: 'Orçamento gratuito em Ribeirão das Neves. O reparo custa muito menos que comprar uma máquina nova.' },
      { question: 'Tem garantia o conserto de máquina de lavar em Ribeirão das Neves?', answer: 'Sim! 90 dias de garantia escrita para todo conserto de máquina de lavar em Ribeirão das Neves.' },
    ],
  },
});
const benefits = [
