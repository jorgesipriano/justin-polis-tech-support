...
Object.assign(serviceConfigs, {
  'conserto-fogao-ribeirao-das-neves': {
    slug: 'conserto-fogao-ribeirao-das-neves',
    title: 'Conserto de Fogão em Ribeirão das Neves',
    subtitle: 'Técnico especializado na sua casa hoje',
    heroDescription: 'Fogão sem acender, com vazamento de gás ou forno que não esquenta em Ribeirão das Neves? A SERVIBEL conserta fogões a gás e elétricos em Ribeirão das Neves com atendimento no mesmo dia. 35 anos de experiência cuidando da segurança da sua família.',
    ctaLabel: '🔥 Conserto de Fogão Hoje',
    whatsappMessage: 'Olá SERVIBEL! Preciso de conserto/reparo no meu fogão em Ribeirão das Neves. Vi pelo site.',
    location: 'Ribeirão das Neves',
    keywords: ['conserto fogão Ribeirão das Neves', 'reparo fogão Ribeirão das Neves', 'arrumar fogão Ribeirão das Neves', 'técnico fogão Ribeirão das Neves', 'conserto forno Ribeirão das Neves', 'fogão a gás Ribeirão das Neves', 'fogão elétrico Ribeirão das Neves'],
    metaTitle: 'Conserto de Fogão em Ribeirão das Neves | Técnico Hoje | SERVIBEL',
    metaDescription: 'Conserto de fogão em Ribeirão das Neves com atendimento no mesmo dia. Reparo de fogão a gás, elétrico e forno em Ribeirão das Neves. 35 anos. Garantia.',
    seoContent: 'Procurando conserto de fogão em Ribeirão das Neves? A SERVIBEL é a assistência técnica de referência em Ribeirão das Neves há 35 anos. Resolvemos todos os problemas do seu fogão em Ribeirão das Neves: bocas não acendem, forno não esquenta, vazamento de gás, válvula travada, faísca fraca, registro com defeito e timer queimado. Atendemos fogões a gás e elétricos em Ribeirão das Neves de todas as marcas: Brastemp, Electrolux, Consul, Atlas, Continental, Dako e Esmaltec. Nossos técnicos chegam até você em qualquer bairro de Ribeirão das Neves — Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Vila Real e demais regiões. Conserto de fogão em Ribeirão das Neves com peças originais e garantia escrita. Não arrisque sua segurança com técnicos improvisados em Ribeirão das Neves — escolha SERVIBEL.',
    faqs: [
      { question: 'Vocês consertam fogão em Ribeirão das Neves hoje?', answer: 'Sim! Atendimento no mesmo dia em Ribeirão das Neves para conserto de fogão. Chame agora pelo WhatsApp.' },
      { question: 'Consertam fogão a gás e elétrico em Ribeirão das Neves?', answer: 'Sim! Fazemos reparo de fogão a gás, elétrico, cooktop e forno em toda Ribeirão das Neves.' },
      { question: 'Meu fogão tem vazamento de gás em Ribeirão das Neves, é urgente?', answer: 'SIM! Vazamento de gás é EMERGÊNCIA. Feche o registro e chame nosso técnico em Ribeirão das Neves agora mesmo.' },
      { question: 'Quanto custa arrumar um fogão em Ribeirão das Neves?', answer: 'O orçamento é gratuito em Ribeirão das Neves. O valor depende do defeito, mas o reparo custa muito menos que um fogão novo.' },
      { question: 'Tem garantia o conserto de fogão em Ribeirão das Neves?', answer: 'Sim! 90 dias de garantia escrita para todo conserto de fogão em Ribeirão das Neves.' },
    ],
  },
  'conserto-secadora-ribeirao-das-neves': {
    slug: 'conserto-secadora-ribeirao-das-neves',
    title: 'Conserto de Secadora de Roupas em Ribeirão das Neves',
    subtitle: 'Reparo especializado no mesmo dia',
    heroDescription: 'Secadora de roupas não esquenta, não gira ou demora horas para secar em Ribeirão das Neves? A SERVIBEL é especialista em conserto de secadoras em Ribeirão das Neves há 35 anos. Atendimento rápido na sua casa.',
    ctaLabel: '👕 Secadora Funcionando Hoje',
    whatsappMessage: 'Olá SERVIBEL! Preciso de conserto na minha secadora em Ribeirão das Neves. Vi pelo site.',
    location: 'Ribeirão das Neves',
    keywords: ['conserto secadora Ribeirão das Neves', 'reparo secadora Ribeirão das Neves', 'arrumar secadora Ribeirão das Neves', 'técnico secadora Ribeirão das Neves', 'secadora de roupas Ribeirão das Neves', 'secadora não esquenta Ribeirão das Neves'],
    metaTitle: 'Conserto de Secadora em Ribeirão das Neves | Reparo Hoje | SERVIBEL',
    metaDescription: 'Conserto de secadora de roupas em Ribeirão das Neves com atendimento no mesmo dia. Reparo de resistência, motor e placa em Ribeirão das Neves. 35 anos. Garantia.',
    seoContent: 'Secadora de roupas com defeito em Ribeirão das Neves é dor de cabeça, principalmente em dias chuvosos. A SERVIBEL é a assistência técnica especializada em secadoras em Ribeirão das Neves, com mais de 35 anos de experiência. Resolvemos em Ribeirão das Neves: secadora não esquenta, não gira o tambor, faz barulho, demora para secar, painel não responde, resistência queimada, sensor de temperatura com defeito e correia rompida. Atendemos todas as marcas de secadora em Ribeirão das Neves: Brastemp, Electrolux, LG, Samsung, Consul, Suggar e Mueller. Nossos técnicos vão até você em qualquer bairro de Ribeirão das Neves: Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Granjas Primavera e demais regiões. Conserto de secadora em Ribeirão das Neves com peças originais, orçamento gratuito e garantia escrita.',
    faqs: [
      { question: 'Minha secadora não esquenta em Ribeirão das Neves, o que pode ser?', answer: 'Geralmente é resistência queimada, sensor de temperatura ou termostato. Nossos técnicos em Ribeirão das Neves fazem o diagnóstico na sua casa.' },
      { question: 'Vocês consertam secadora em Ribeirão das Neves no mesmo dia?', answer: 'Sim! Atendimento em até 24h em Ribeirão das Neves para conserto de secadora.' },
      { question: 'Consertam secadora de todas as marcas em Ribeirão das Neves?', answer: 'Sim! Brastemp, Electrolux, LG, Samsung, Consul, Suggar, Mueller e todas as marcas em Ribeirão das Neves.' },
      { question: 'Quanto custa o reparo de secadora em Ribeirão das Neves?', answer: 'Orçamento gratuito em Ribeirão das Neves. O reparo custa muito menos que comprar uma secadora nova.' },
      { question: 'Quais bairros de Ribeirão das Neves atendem?', answer: 'TODOS os bairros de Ribeirão das Neves: Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Vila Real e demais regiões.' },
    ],
  },
  'conserto-cooktop-ribeirao-das-neves': {
    slug: 'conserto-cooktop-ribeirao-das-neves',
    title: 'Conserto de Cooktop em Ribeirão das Neves',
    subtitle: 'Técnico especializado em cooktop a gás e elétrico',
    heroDescription: 'Cooktop não acende, queimadores fracos ou superfície de indução com erro em Ribeirão das Neves? A SERVIBEL é especialista em conserto de cooktops em Ribeirão das Neves. Atendimento rápido e seguro na sua casa.',
    ctaLabel: '🔧 Conserto de Cooktop Hoje',
    whatsappMessage: 'Olá SERVIBEL! Preciso de conserto/reparo no meu cooktop em Ribeirão das Neves. Vi pelo site.',
    location: 'Ribeirão das Neves',
    keywords: ['conserto cooktop Ribeirão das Neves', 'reparo cooktop Ribeirão das Neves', 'arrumar cooktop Ribeirão das Neves', 'cooktop a gás Ribeirão das Neves', 'cooktop indução Ribeirão das Neves', 'cooktop elétrico Ribeirão das Neves', 'técnico cooktop Ribeirão das Neves'],
    metaTitle: 'Conserto de Cooktop em Ribeirão das Neves | Gás e Indução | SERVIBEL',
    metaDescription: 'Conserto de cooktop em Ribeirão das Neves com atendimento no mesmo dia. Reparo de cooktop a gás, elétrico e indução em Ribeirão das Neves. 35 anos. Garantia.',
    seoContent: 'Cooktop com defeito em Ribeirão das Neves? A SERVIBEL é a assistência técnica especializada em cooktops em Ribeirão das Neves há 35 anos. Consertamos cooktop a gás, elétrico e indução em Ribeirão das Neves. Resolvemos todos os problemas: boca não acende, faísca fraca, vazamento de gás, válvula travada, queimador entupido, painel touch sem resposta, indução com erro no display, vidro temperado trincado e fiação com defeito. Atendemos todas as marcas de cooktop em Ribeirão das Neves: Brastemp, Electrolux, Consul, Fischer, Tramontina, Atlas, Continental e Mueller. Nossos técnicos chegam até você em qualquer bairro de Ribeirão das Neves: Justinópolis, Rosaneves, Veneza, Maria Helena, Areias, Botafogo, Fortaleza, Granjas Primavera, Vila Real e demais regiões. Conserto de cooktop em Ribeirão das Neves com peças originais e garantia escrita. Para sua segurança, escolha quem tem experiência: SERVIBEL Ribeirão das Neves.',
    faqs: [
      { question: 'Vocês consertam cooktop a gás e indução em Ribeirão das Neves?', answer: 'Sim! Fazemos reparo de cooktop a gás, elétrico e indução em toda Ribeirão das Neves.' },
      { question: 'Meu cooktop de indução está dando erro em Ribeirão das Neves, vocês arrumam?', answer: 'Sim! Nossos técnicos em Ribeirão das Neves são especializados em cooktop de indução e diagnóstico de erros do display.' },
      { question: 'Vazamento de gás no cooktop em Ribeirão das Neves, é urgente?', answer: 'SIM! Vazamento de gás é EMERGÊNCIA. Feche o registro principal e chame nosso técnico em Ribeirão das Neves agora.' },
      { question: 'Quanto custa o conserto de cooktop em Ribeirão das Neves?', answer: 'Orçamento gratuito em Ribeirão das Neves. O reparo custa uma fração do valor de um cooktop novo.' },
      { question: 'Tem garantia o conserto de cooktop em Ribeirão das Neves?', answer: 'Sim! 90 dias de garantia escrita para todo conserto de cooktop em Ribeirão das Neves.' },
    ],
  },
});
const benefits = [
